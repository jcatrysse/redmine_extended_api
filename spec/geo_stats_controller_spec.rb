...
require_relative '../app/controllers/geo_stats_controller'
...
RSpec.describe GeoStatsController do
  ...
  describe '.accept_api_auth' do
    it 'declares monthly_flow as an API-auth action' do
      expect(described_class.accepted_api_auth_actions).to include(:monthly_flow)
    end
  end
